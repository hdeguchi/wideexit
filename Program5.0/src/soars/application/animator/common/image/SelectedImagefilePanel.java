...
public class SelectedImagefilePanel extends JPanel implements IThumbnailListCallback {
	 ...
	 */
	static private BufferedImage _bufferedImage = new BufferedImage( AnimatorImageManager._thumbnailSize, AnimatorImageManager._thumbnailSize, BufferedImage.TYPE_INT_ARGB);
	...
	public void update() {
		...
		File file = new File( Administrator.get_instance().get_thumbnail_image_directory(), filename);
