...
public class ThumbnailPanel extends JPanel {
	...
	private boolean setup_thumbnailList(String imageFilename, String openDirectoryKey, JPanel parent) {
		...
		_thumbnailList = new ThumbnailList( Administrator.get_instance().get_image_directory(),
			Administrator.get_instance().get_thumbnail_image_directory(), openDirectoryKey,
