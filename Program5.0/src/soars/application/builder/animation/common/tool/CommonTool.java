 ...
 * 
 */
package soars.application.builder.animation.common.tool;
...
import soars.application.builder.animation.main.Environment;
...
public class CommonTool {
	 ...
	 * @return
	 */
	public static File get_animator_file( String open_directory_key, String title, Component component) {
