...
public class ResourceManager extends ResourceManagerBase {
	 ...
	 * 
	 */
	static private String _filePath = "../resource/properties/application/manager/library/Resource_%s.properties";

	/**
	 * 
	 */
	static private String _defaultFilePath = "../resource/properties/application/manager/library/Resource.properties";
