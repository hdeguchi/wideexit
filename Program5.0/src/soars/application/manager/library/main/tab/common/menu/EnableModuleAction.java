 ...
 *
 */
public class EnableModuleAction extends MenuAction {
	 ...
	 */
	public EnableModuleAction(String name, IContextMenuHandler contextMenuHandler) {
		super(name);
	...
	public void selected(ActionEvent actionEvent) {
		_contextMenuHandler.on_enable_module(actionEvent);
	}
}
