...
public class ResourceManager extends ResourceManagerBase {
	 ...
	 * 
	 */
	static private String _filePath = "../resource/properties/application/simulator/Resource_%s.properties";

	/**
	 * 
	 */
	static private String _defaultFilePath = "../resource/properties/application/simulator/Resource.properties";
