...
public class WarningDlg1 extends Dialog {
	...
	private Rectangle get_rectangle_from_environment_file() {
		String value = Environment.get_instance().get(
			Environment._warningDialog1RectangleKey + "x",
		...
		value = Environment.get_instance().get(
			Environment._warningDialog1RectangleKey + "y",
			String.valueOf( SwingTool.get_default_window_position(
				( null != _parent) ? _parent : getOwner(),
		...
		value = Environment.get_instance().get(
			Environment._warningDialog1RectangleKey + "width",
		...
		value = Environment.get_instance().get(
			Environment._warningDialog1RectangleKey + "height",
	...
	protected void set_property_to_environment_file() {
		...
		Environment.get_instance().set(
			Environment._warningDialog1RectangleKey + "x", String.valueOf( rectangle.x));
		Environment.get_instance().set(
			Environment._warningDialog1RectangleKey + "y", String.valueOf( rectangle.y));
		Environment.get_instance().set(
			Environment._warningDialog1RectangleKey + "width", String.valueOf( rectangle.width));
		Environment.get_instance().set(
			Environment._warningDialog1RectangleKey + "height", String.valueOf( rectangle.height));
	}
