...
public class ResourceManager extends ResourceManagerBase {
	 ...
	 * 
	 */
	static private String _filePath = "bin/resource/properties/application/manager/model/Resource_%s.properties";

	/**
	 * 
	 */
	static private String _defaultFilePath = "bin/resource/properties/application/manager/model/Resource.properties";
