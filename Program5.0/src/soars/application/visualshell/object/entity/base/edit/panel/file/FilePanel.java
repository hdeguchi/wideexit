...
public class FilePanel extends PanelBase {
	 ...
	 * @param parent
	 */
	public FilePanel(EntityBase entityBase, Map<String, PropertyPanelBase> propertyPanelBaseMap, VariableTableBase variableTableBase, FileManager fileManager, Color color, Frame owner, Component parent) {
		super("file", entityBase, propertyPanelBaseMap, variableTableBase, color, owner, parent);
	...
	private void setup_initialValueTextField(JPanel parent) {
		...
		_initialValueTextField = !_entityBase.is_multi() ? new FileAndDirectoryDDTextField() : new JTextField();
	...
	protected boolean can_get_data(ObjectBase objectBase) {
		...
		String[] property_pages = Constant.get_propertyPanelBases( "file");
