 ...
 * @author kurata
 */
public class InitialDataFilePropertyPanel extends PropertyPanelBase implements IFileManagerCallBack {
	 ...
	 * @param parent
	 */
	public InitialDataFilePropertyPanel(String title, EntityBase entityBase, Map<String, PropertyPanelBase> propertyPanelBaseMap, int index, Frame owner, Component parent) {
	...
	protected void set_property_to_environment_file() {
		Environment.get_instance().set(
			Environment._editObjectDialogInitialDataFilePropertyPanelDividerLocationKey, String.valueOf( _splitPane.getDividerLocation()));
		Environment.get_instance().set(
...
//	}
	...
	protected boolean on_create() {
		...
		_splitPane.setDividerLocation( Integer.parseInt( Environment.get_instance().get( Environment._editObjectDialogInitialDataFilePropertyPanelDividerLocationKey, "250")));
	...
	private void create_fileTable() {
		_initialDataFileTable = new InitialDataFileTable( _entityBase, _propertyPanelBaseMap, this, _owner, _parent);
	}
	...
	private boolean setup_components(JPanel parent) {
		_initialDataFilePanel = new InitialDataFilePanel( _entityBase, _propertyPanelBaseMap, _initialDataFileTable, _fileManager, SystemColor.textText, _owner, _parent);
	...
	public boolean can_remove(File file) {
		...
		return ( !_initialDataFileTable.uses_this_file( file)
			...
			//&& !LayerManager.get_instance().uses_this_file( file, "initial data file"));
	}
	...
	/* (non-Javadoc)
	 * @see soars.application.visualshell.object.entity.baentityit.panel.base.PropertyPanelBase#move_file(java.io.File, java.io.File)
	 */
	@Override
