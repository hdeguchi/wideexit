 ...
 * 
 */
package soars.application.visualshell.object.entity.base.edit.panel.variable.panel.set_and_list.set;
...
public class SetPanel extends VariablePanel {
	 ...
	 * @param parent
	 */
	public SetPanel(EntityBase entityBase, Map<String, PropertyPanelBase> propertyPanelBaseMap, VariableTable variableTable, Color color, Frame owner, Component parent) {
		super("collection", entityBase, propertyPanelBaseMap, variableTable, color, owner, parent);
	}
