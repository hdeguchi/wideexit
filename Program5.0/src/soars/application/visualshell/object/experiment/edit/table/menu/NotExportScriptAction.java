...
/**
 * The menu handler of "Export off" menu.
 * @author kurata / SOARS project
 */
public class NotExportScriptAction extends MenuAction {
	...
	/**
	 * Creates the menu handler of "Export off" menu
	 * @param name the Menu name
	 * @param experimentRowHeaderTable the table component to edit the experiment data
	 */
	public NotExportScriptAction(String name, ExperimentRowHeaderTable experimentRowHeaderTable) {
		super(name);
	...
	public void selected(ActionEvent actionEvent) {
		_experimentRowHeaderTable.on_not_export_script( actionEvent);
	}
}
