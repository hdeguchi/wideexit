 ...
 *
 */
public class GisInitialValueTableBase extends TableBase implements IBasicMenuHandler1, IBasicMenuHandler2 {
	 ...
	 * 
	 */
	protected GisVariablePanelBase _gisVariablePanelBase = null;

	/**
	 * 
	 */
	public GisInitialValueTableBase _gisInitialValueTableBase = null;
...
//	}
	 ...
	 * 
	 */
	static public Map<String, String> get_typeMap() {
		return InitialValueTableBase.__typeMap;
	}
	...
	static public Map<String, String> get_nameMap() {
		return InitialValueTableBase.__nameMap;
	}
	 ...
	 * @param parent
	 */
	public GisInitialValueTableBase(Color color, GisDataManager gisDataManager, GisVariablePanelBase gisVariablePanelBase, Frame owner, Component parent) {
		super(owner, parent);
		_color = color;
		_gisDataManager = gisDataManager;
		_gisVariablePanelBase = gisVariablePanelBase;
	}
	...
	public boolean setup(GisInitialValueTableBase gisInitialValueTableBase) {
		...
		_gisInitialValueTableBase = gisInitialValueTableBase;
	...
	protected void on_mouse_pressed(MouseEvent mouseEvent) {
		...
		if ( ( 0 <= row && getRowCount() > row)
			...
			_gisInitialValueTableBase.setColumnSelectionInterval( 0, _gisInitialValueTableBase.getColumnCount() - 1);
		}
	}
