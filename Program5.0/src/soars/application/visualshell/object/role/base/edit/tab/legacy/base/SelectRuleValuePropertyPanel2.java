 ...
 * @author kurata
 */
public class SelectRuleValuePropertyPanel2 extends RulePropertyPanelBase {
	 ...
	 * @param parent
	 */
	public SelectRuleValuePropertyPanel2(String title, String kind, String type, Color color, Role role, int index, String label, boolean canEmpty, Frame owner, EditRoleFrame parent) {
	...
	public boolean set(Rule rule) {
		...
		_valueComboBox.setSelectedItem( rule._value.substring( ( rule._value.startsWith( "!")) ? ( "!".length()) : 0));
