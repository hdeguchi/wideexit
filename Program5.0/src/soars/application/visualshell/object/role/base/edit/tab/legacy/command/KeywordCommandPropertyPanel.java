 ...
 * @author kurata
 */
public class KeywordCommandPropertyPanel extends RulePropertyPanelBase {
	 ...
	 * @param parent
	 */
	public KeywordCommandPropertyPanel(String title, String kind, String type, Color color, Role role, int index, Frame owner, EditRoleFrame parent) {
