 ...
 */
package soars.application.visualshell.object.role.base.edit.tab.legacy.command.base;
 ...
 * @author kurata
 */
public class CollectionAndListCommandPropertyPanelBase extends RulePropertyPanelBase {
	 ...
	 * @param parent
	 */
	public CollectionAndListCommandPropertyPanelBase(String title, String kind, String type, Color color, Role role, int index, Frame owner, EditRoleFrame parent) {
