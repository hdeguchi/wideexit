 ...
 * @author kurata
 */
public class AgentEquipCommandPropertyPanel extends EquipCommandPropertyPanelBase {
	 ...
	 * @param parent
	 */
	public AgentEquipCommandPropertyPanel(String title, String kind, Color color, Role role, int index, Frame owner, EditRoleFrame parent) {
