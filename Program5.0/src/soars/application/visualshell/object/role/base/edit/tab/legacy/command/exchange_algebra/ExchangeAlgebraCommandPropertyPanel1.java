 ...
 * @author kurata
 */
public class ExchangeAlgebraCommandPropertyPanel1 extends RulePropertyPanelBase {
	 ...
	 * @param parent
	 */
	public ExchangeAlgebraCommandPropertyPanel1(String title, String kind, String type, Color color, Role role, int index, Frame owner, EditRoleFrame parent) {
