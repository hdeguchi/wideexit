 ...
 *
 */
public class ListCommandPropertyPanel4 extends CollectionAndListCommandPropertyPanelBase {
	 ...
	 * @param parent
	 */
	public ListCommandPropertyPanel4(String title, String kind, String type, Color color, Role role, int index, Frame owner, EditRoleFrame parent) {
	...
	private void update_components(boolean[] enables) {
		...
		_removeAllListComboBox.setEnabled( enables[ 3]);

		_label[ 5].setEnabled( enables[ 4]);
		_removeAllCollectionComboBox.setEnabled( enables[ 4]);
