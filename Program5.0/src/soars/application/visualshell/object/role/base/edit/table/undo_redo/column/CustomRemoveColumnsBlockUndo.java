 ...
 *
 */
public class CustomRemoveColumnsBlockUndo extends RemoveColumnsBlockUndo {
	 ...
	 */
	public CustomRemoveColumnsBlockUndo(int rowFrom, int rowTo, int columnFrom, int columnTo, List<SetValueUndo> setValueUndoListForOr, JTable table, ITableUndoRedoCallBack tableUndoRedoCallBack) {
