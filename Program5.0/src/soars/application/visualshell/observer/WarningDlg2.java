...
public class WarningDlg2 extends Dialog {
	...
	protected boolean on_init_dialog() {
		...
		setup_continue_button( southPanel);

		insert_horizontal_glue( southPanel);

		setup_abort_button( southPanel);
	 ...
	 * 
	 */
	private void setup_continue_button(JPanel parent) {
		JPanel panel = new JPanel();
		panel.setLayout( new BoxLayout( panel, BoxLayout.X_AXIS));
	 ...
	 * 
	 */
	private void setup_abort_button(JPanel parent) {
		JPanel panel = new JPanel();
		panel.setLayout( new BoxLayout( panel, BoxLayout.X_AXIS));
