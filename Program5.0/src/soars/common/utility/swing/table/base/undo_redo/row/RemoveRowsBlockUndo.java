 ...
 *
 */
public class RemoveRowsBlockUndo extends BaseUndo {
	 ...
	 */
	public RemoveRowsBlockUndo(int rowFrom, int rowTo, int columnFrom, int columnTo, JTable table, ITableUndoRedoCallBack tableUndoRedoCallBack) {
	...
	public void undo() throws CannotUndoException {
		super.undo();
		_tableUndoRedoCallBack.removeRowsBlock( "undo", this);
	}
	...
	public void redo() throws CannotRedoException {
		super.redo();
		_tableUndoRedoCallBack.removeRowsBlock( "redo", this);
	}
}
