 ...
 * 
 */
package soars.common.utility.tool.ssh;
...
public class SshTool {
	 ...
	 * @return
	 */
	public static boolean directory_exists(String host, String username, String password, String directory) {
		SshClient sshClient = getSshClient( host, username, password);
		if ( null == sshClient)
			return false;
	 ...
	 * @param file
	 */
	public static boolean file_exists(String host, String username, String password, String file) {
		SshClient sshClient = getSshClient( host, username, password);
		if ( null == sshClient)
			return false;
	 ...
	 * @return
	 */
	public static List ls(String host, String username, String password) {
		SshClient sshClient = getSshClient( host, username, password);
		if ( null == sshClient)
			return null;
	 ...
	 * @return
	 */
	public static List ls(String host, String username, String password, String directory) {
		SshClient sshClient = getSshClient( host, username, password);
		if ( null == sshClient)
			return null;
	 ...
	 * @return
	 */
	public static boolean mkdirs(String host, String username, String password, String path) {
		SshClient sshClient = getSshClient( host, username, password);
		if ( null == sshClient)
			return false;
	 ...
	 * @return
	 */
	public static boolean rename(String host, String username, String password, String oldpath, String newpath) {
		SshClient sshClient = getSshClient( host, username, password);
		if ( null == sshClient)
			return false;
	 ...
	 * @return
	 */
	public static boolean delete(String host, String username, String password, String path, boolean self) {
		SshClient sshClient = getSshClient( host, username, password);
		if ( null == sshClient)
			return false;
	 ...
	 * @return
	 */
	public static boolean rm(String host, String username, String password, String path) {
		SshClient sshClient = getSshClient( host, username, password);
		if ( null == sshClient)
			return false;
	 ...
	 * @return
	 */
	public static String execute1(String host, String username, String password, String command) {
		SshClient sshClient = getSshClient( host, username, password);
		if ( null == sshClient)
			return null;
	 ...
	 * @return
	 */
	public static String execute2(String host, String username, String password, String command) {
		SshClient sshClient = getSshClient( host, username, password);
		if ( null == sshClient)
			return null;
...
//	}
	 ...
	 * @return
	 */
	public static boolean transfer(String host, String username, String password, SftpFile srcDirectory, File destDirectory,
