...
import soars.common.utility.tool.ssh.filechooser.menu.DeleteAction;
import soars.common.utility.tool.ssh.filechooser.menu.NewAction;
import soars.common.utility.tool.ssh.filechooser.menu.RenameAction;
...
public class SftpFileList extends JList {
	 ...
	 * @return
	 */
	public boolean update(String host, String username, String password, String directory,
		boolean fileSelectionEnabled, boolean directorySelectionEnabled) {
		List sftpFileList = SshTool.ls( host, username, password, directory);
