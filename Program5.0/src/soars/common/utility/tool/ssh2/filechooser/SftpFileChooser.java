...
public class SftpFileChooser extends Dialog implements IMessageCallback {
	...
	*/
	public SftpFileChooser(Frame arg0, String arg1, String host, String username, String keyFilename, String currentDirectory, String homeDirectory) throws HeadlessException {
	 ...
	 * @throws HeadlessException
	*/
	public SftpFileChooser(Frame arg0, String arg1, String host, String username, String keyFilename, String currentDirectory, String homeDirectory, String rootDirectory) throws HeadlessException {
		super(arg0, arg1, true);
		_host = host;
		_username = username;
		_keyFilename = keyFilename;
	...
	*/
	...
	public void update(String directory) {
		...
		if ( _sftpDirectoryComboBox.update( directory, _rootDirectory)
			&& _sftpFileList.update( _host, _username, _keyFilename, directory,
				isFileSelectionEnabled(), isDirectorySelectionEnabled()))
			_currentDirectory = directory;
		else {
			if ( !_sftpDirectoryComboBox.update( _currentDirectory, _rootDirectory)
				|| !_sftpFileList.update( _host, _username, _keyFilename, _currentDirectory,
					isFileSelectionEnabled(), isDirectorySelectionEnabled())) {
				_sftpDirectoryComboBox.update( _homeDirectory, _rootDirectory);
				_sftpFileList.update( _host, _username, _keyFilename, _homeDirectory,
					isFileSelectionEnabled(), isDirectorySelectionEnabled());
	...
	public boolean message_callback(String id, Object[] objects, MessageDlg messageDlg) {
		if ( id.equals( "mkdir"))
			return SshTool2.mkdirs( _host, _username, new File( _keyFilename), ( String)objects[ 0]);
		else if ( id.equals( "rename"))
			return SshTool2.rename( _host, _username, new File( _keyFilename), ( String)objects[ 0], ( String)objects[ 1]);
		else if ( id.equals( "delete"))
			return SshTool2.delete( _host, _username, new File( _keyFilename), ( String)objects[ 0], true);
	...
	protected void on_setup_completed() {
		...
		_sftpFileList.update( _host, _username, _keyFilename, parentDirectory,
			isFileSelectionEnabled(), isDirectorySelectionEnabled());
