 ...
 * 
 */
package soars.library.adapter.questionnaire;
...
//			JOptionPane.INFORMATION_MESSAGE);
	...
	public static void publish(EquippedObject equippedObject, String arg0, String arg1, String arg2) {
		...
		if ( object instanceof String)
			...
			String message = getMessage( ( LinkedList<?>)object);
			if ( message.equals( ""))
				return;

			MqttPublisher.publishStringUTF8( _mqttBufferedSessionMap.get( equippedObject), topic, message);
		}
	}
	 ...
	 * @return
	 */
	private static String getMessage(LinkedList<?> lists) {
		String message = "";
		for ( Object element:lists) {
			...
			for ( Object object:list)
				message += object.toString() + ( list.getLast() != object ? "," : CommonConstant._lineSeparator);
		}
		return message;
	}
