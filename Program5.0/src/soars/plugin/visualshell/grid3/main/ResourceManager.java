...
public class ResourceManager extends ResourceManagerBase {
	 ...
	 * 
	 */
	static private String _filePath = "../resource/properties/plugin/visualshell/grid3/Resource_%s.properties";

	/**
	 * 
	 */
	static private String _defaultFilePath = "../resource/properties/plugin/visualshell/grid3/Resource.properties";
