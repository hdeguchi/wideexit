...
public class Environment extends EnvironmentBase {
	 ...
	 * 
	 */
	static public final String _usernameKey = "Username";

	/**
	 * 
	 */
	static public final String _privateKeyFilenameKey = "Private.key.filename";
	...
	public Environment() {
		super(
			System.getProperty( Constant._soarsProperty) + File.separator
				...
				+ "xgrid1" + File.separator
				+ "environment" + File.separator,
			"environment.properties",
			"SOARS Visual Shell Plugin Xgrid1 properties");
	}
