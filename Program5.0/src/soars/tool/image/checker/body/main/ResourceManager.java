...
public class ResourceManager extends ResourceManagerBase {
	 ...
	 * 
	 */
	static private String _filePath = "../../../resource/properties/tool/image/checker/body/Resource_%s.properties";

	/**
	 * 
	 */
	static private String _defaultFilePath = "../../../resource/properties/tool/image/checker/body/Resource.properties";
